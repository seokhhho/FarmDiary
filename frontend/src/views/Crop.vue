    ...
    <div class="main main-raised">
      ...
      <div class="md-layout-item">
        <div class="tim-typo" v-if="cropsDetail.environment">
          ...
          <p class="text-muted" v-html="cropsDetail.environment">
          </p>
        </div>
        <div class="tim-typo" v-if="cropsDetail.preparation">
          ...
          <p class="text-muted" v-html="cropsDetail.preparation">
          </p>
        </div>
        <div class="tim-typo" v-if="cropsDetail.plant">
          ...
          <p class="text-muted" v-html="cropsDetail.plant">
          </p>
        </div>
        <div class="tim-typo" v-if="cropsDetail.manage">
          ...
          <p class="text-muted" v-html="cropsDetail.manage">
          </p>
        </div>
        <div class="tim-typo" v-if="cropsDetail.harvest">
          ...
          <p class="text-muted" v-html="cropsDetail.harvest">
          </p>
        </div>
        <div class="tim-typo" v-if="cropsDetail.nutri">
          ...
          <p class="text-muted" v-html="cropsDetail.nutri">
          </p>
        </div>
      </div>
      </div>
